...
set_property PACKAGE_PIN W19 [get_ports twenty_fives]
set_property IOSTANDARD LVCMOS33 [get_ports twenty_fives]

set_property PACKAGE_PIN U18 [get_ports tens]
set_property IOSTANDARD LVCMOS33 [get_ports tens]

set_property PACKAGE_PIN T17 [get_ports fives]
set_property IOSTANDARD LVCMOS33 [get_ports fives]
...
set_property PACKAGE_PIN V4 [get_ports {anodes[3]}]
...
set_property PACKAGE_PIN U2 [get_ports {anodes[1]}]
